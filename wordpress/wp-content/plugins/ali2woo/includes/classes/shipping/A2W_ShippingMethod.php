                    ...
                    { 
                       ...
                       $price = $_product->get_price();
                        ...
                        if ($ext_id){
                            ...
                            // Important! Need to use $_product->get_id() due to _a2w_country_code can be only in variation
                            $from_country = get_post_meta($_product->get_id(), '_a2w_country_code', true);

                            $shipping_meta = new A2W_ShippingMeta($product_id);

                            $response = $this->shipping_loader->load($shipping_meta, $ext_id, $from_country, $to_country, $values['quantity'], $price, $price);
