    ...
    class A2W_SettingPageController extends A2W_AbstractAdminPage {
        ...
        public function ajax_update_price_rules() {
            ...
            try {
                ...
                a2w_set_setting('add_shipping_to_price', isset($_POST['add_shipping_to_price'])?!!$_POST['add_shipping_to_price']:false);
                a2w_set_setting('apply_price_rules_after_shipping_cost', isset($_POST['apply_price_rules_after_shipping_cost'])?!!$_POST['apply_price_rules_after_shipping_cost']:false);
