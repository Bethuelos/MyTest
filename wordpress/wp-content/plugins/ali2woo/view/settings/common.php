        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="info-box" data-toggle="tooltip" title="<?php _ex("Change the order status when the order has been placed with the Chrome extension", 'setting description', 'ali2woo'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
